...
export const env = {
  ...
  inboundAiDebounceSeconds: clampInt(process.env.INBOUND_AI_DEBOUNCE_SECONDS, 7, 1, 60),
  resendApiKey: requireEnv("RESEND_API_KEY"),
  resendFromEmail: process.env.RESEND_FROM_EMAIL ?? "Senqo Notifications <whatsapp@notification.senqo.app>",
  ...
  whatsappServiceUrl: process.env.WHATSAPP_SERVICE_URL ?? "http://whatsapp:8080",
