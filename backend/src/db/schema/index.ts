...
export const conversations = pgTable("conversations", {
  ...
  unique("uq_conversations_workspace_whatsapp_chat_id").on(t.workspaceId, t.whatsappChatId),
  index("idx_conversations_workspace_updated").on(t.workspaceId, t.updatedAt.desc()),
  index("idx_conversations_workspace_unarchived_updated").on(t.workspaceId, t.updatedAt.desc()),
]);
...
}, (t) => [index("idx_messages_conversation_created").on(t.conversationId, t.createdAt.asc())]);
...
export const whatsappConnections = pgTable("whatsapp_connections", {
  ...
  index("idx_whatsapp_connections_workspace").on(t.workspaceId),
]);
...
export const agentConfigs = pgTable("agent_configs", {
  ...
  autoAssignConversationLabels: boolean("auto_assign_conversation_labels").notNull().default(true),
...
}, (t) => [index("idx_agent_configs_workspace_active").on(t.workspaceId, t.updatedAt.desc())]);

export const whatsappWebhookEvents = pgTable("whatsapp_webhook_events", {
  id: uuid("id").primaryKey().defaultRandom(),
  workspaceId: uuid("workspace_id").notNull().references(() => workspaces.id, { onDelete: "cascade" }),
  whatsappConnectionId: uuid("whatsapp_connection_id").references(() => whatsappConnections.id, { onDelete: "set null" }),
  ...
  index("idx_whatsapp_webhook_events_workspace_created").on(t.workspaceId, t.createdAt.desc()),
]);
...
export const agentSessions = pgTable("agent_sessions", {
  ...
  createdAt: timestamp("created_at", { withTimezone: true }).notNull().defaultNow(),
  updatedAt: timestamp("updated_at", { withTimezone: true }).notNull().defaultNow(),
}, (t) => [index("idx_agent_sessions_workspace_created").on(t.workspaceId, t.createdAt.desc())]);
...
export const agentMessages = pgTable("agent_messages", {
  ...
  index("idx_agent_messages_session_created").on(t.agentSessionId, t.createdAt.asc()),
  index("idx_agent_messages_workspace_created").on(t.workspaceId, t.createdAt.desc()),
...
export const workspaceSkillDefinitions = pgTable("workspace_skill_definitions", {
  ...
  index("idx_workspace_skill_definitions_workspace_updated").on(t.workspaceId, t.updatedAt.desc()),
]);

export const tasks = pgTable("tasks", {
  id: uuid("id").primaryKey().defaultRandom(),
  workspaceId: uuid("workspace_id").notNull().references(() => workspaces.id, { onDelete: "cascade" }),
  agentConfigId: uuid("agent_config_id").notNull().references(() => agentConfigs.id, { onDelete: "restrict" }),
...
export const taskRuns = pgTable("task_runs", {
  ...
  index("idx_task_runs_workspace_created").on(t.workspaceId, t.createdAt.desc()),
]);
...
export const conversationLabelAssignments = pgTable("conversation_label_assignments", {
  ...
  index("idx_conversation_label_assignments_workspace_label").on(t.workspaceId, t.labelId),
  index("idx_conversation_label_assignments_conversation").on(t.conversationId),
]);
...
export const agentAssets = pgTable("agent_assets", {
  id: uuid("id").primaryKey().defaultRandom(),
  workspaceId: uuid("workspace_id").notNull().references(() => workspaces.id, { onDelete: "cascade" }),
  groupId: uuid("group_id").notNull().references(() => workspaceAssetGroups.id, { onDelete: "cascade" }),
...
export const workspaceResponseTemplateGroups = pgTable("workspace_response_template_groups", {
  id: uuid("id").primaryKey().defaultRandom(),
  workspaceId: uuid("workspace_id").notNull().references(() => workspaces.id, { onDelete: "cascade" }),
  name: text("name").notNull(),
  updatedAt: timestamp("updated_at", { withTimezone: true }).notNull().defaultNow(),
...
export const workspaceResponseTemplateEntries = pgTable("workspace_response_template_entries", {
  id: uuid("id").primaryKey().defaultRandom(),
  groupId: uuid("group_id").notNull().references(() => workspaceResponseTemplateGroups.id, { onDelete: "cascade" }),
  title: text("title").notNull(),
...
export const workspaceHandoffTopicGroups = pgTable("workspace_handoff_topic_groups", {
  id: uuid("id").primaryKey().defaultRandom(),
  workspaceId: uuid("workspace_id").notNull().references(() => workspaces.id, { onDelete: "cascade" }),
  name: text("name").notNull(),
  updatedAt: timestamp("updated_at", { withTimezone: true }).notNull().defaultNow(),
...
export const workspaceHandoffTopicEntries = pgTable("workspace_handoff_topic_entries", {
  id: uuid("id").primaryKey().defaultRandom(),
  groupId: uuid("group_id").notNull().references(() => workspaceHandoffTopicGroups.id, { onDelete: "cascade" }),
  title: text("title").notNull(),
  description: text("description").notNull().default(""),
  sortOrder: integer("sort_order").notNull().default(0),
  createdAt: timestamp("created_at", { withTimezone: true }).notNull().defaultNow(),
...
export const workspaceContextEntries = pgTable("workspace_context_entries", {
  id: uuid("id").primaryKey().defaultRandom(),
  groupId: uuid("group_id").notNull().references(() => workspaceContextGroups.id, { onDelete: "cascade" }),
  title: text("title").notNull(),
  body: text("body").notNull().default(""),
  sortOrder: integer("sort_order").notNull().default(0),
  createdAt: timestamp("created_at", { withTimezone: true }).notNull().defaultNow(),
